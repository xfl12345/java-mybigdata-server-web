...
@Slf4j
public class MyOutputContextImpl implements OutputContext, HttpServletResponseGetter {
    ...
    public MyOutputContextImpl(HttpServletResponse response, OutputStream out) {
        if (response == null) {
