...
import cc.xfl12345.mybigdata.server.model.api.database.handler.NumberTypeHandler;
import cc.xfl12345.mybigdata.server.model.api.database.handler.StringTypeHandler;
import cc.xfl12345.mybigdata.server.model.database.association.IntegerContentGlobalRecordAssociation;
...
import cc.xfl12345.mybigdata.server.model.api.database.result.NumberTypeResult;
import cc.xfl12345.mybigdata.server.model.api.database.result.ResultUtils;
    ...
    public NumberTypeResult selectNumber(BigDecimal number) {
        ...
        if (isLongInteger(number)) {
            ...
            try {
                ...
                IntegerContentGlobalRecordAssociation association = new IntegerContentGlobalRecordAssociation();
            ...
            switch (CoreTableNames.valueOf(tableName)) {
                ...
                default -> {
                    ...
                    result.setMessage("获取数字只能从"
                        + " \"" + CoreTableNames.INTEGER_CONTENT + "\" "
                        + "或者"
                        + " \"" + CoreTableNames.STRING_CONTENT + "\" "
                        + "这两个表中获取，数据库存储的数据有误。"
                    );
                }
            }
