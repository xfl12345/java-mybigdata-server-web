...
public class BeeOrmTableHandlerConfigGenerator {

    public static <TablePojoType> BeeOrmTableHandlerConfig<TablePojoType> getConfig(Class<TablePojoType> cls) throws NoSuchMethodException {
        String tableName;
        ...
        SimpleBeeOrmTableHandlerConfig<TablePojoType> config = new SimpleBeeOrmTableHandlerConfig<>();
